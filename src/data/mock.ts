...
// Booked days are computed relative to today so the vet's calendar always shows
// current bookings (offset in days from today).
const bookingDay = (offset: number): string => {
  const d = new Date();
...
export const calloutRequests: CalloutRequest[] = [
  { id: 1, farmerName: 'Patrick Etyang', animal: 'Bull #A-042', locationName: 'North Paddock', distanceKm: 2.4, urgency: 'Emergency', notes: 'Visible limp on the front left leg, not grazing.', requestedAt: '10 min ago', status: 'pending', scheduledFor: bookingDay(0), scheduledSlot: '08:00–10:00' },
  { id: 2, farmerName: 'Grace Wanjiru', animal: 'Cow #A-017', locationName: 'Water Point A', distanceKm: 5.1, urgency: 'Routine', notes: 'Reduced milk yield over the last 3 days.', requestedAt: '40 min ago', status: 'pending', scheduledFor: bookingDay(0), scheduledSlot: '10:00–12:00' },
  { id: 3, farmerName: 'Daniel Mwangi', animal: 'Heifer #A-061', locationName: 'South Paddock', distanceKm: 8.3, urgency: 'Routine', notes: 'Routine pregnancy check.', requestedAt: '2 hours ago', status: 'accepted', scheduledFor: bookingDay(0), scheduledSlot: '14:00–16:00' },
  { id: 4, farmerName: 'Esther Achieng', animal: 'Cow #A-008', locationName: 'Holding Yard', distanceKm: 11.6, urgency: 'Routine', notes: 'Annual vaccination due.', requestedAt: 'Yesterday', status: 'completed', scheduledFor: bookingDay(2), scheduledSlot: '08:00–10:00' },
];
